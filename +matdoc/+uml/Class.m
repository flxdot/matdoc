    ...
    methods
        ...
        function umlStr = getPlantUML(this, ident_)
            ...
            if ~this.Configuration.HideEnumerationMember
                umlStr = sprintf('%s%s',...
                    umlStr,...
                    getPlantUmlEnumerationValues(this, ident_ + matdoc.uml.super.Base.UML_IDENT)...
                    );
            ...
            if ~this.Configuration.HideProperties
                umlStr = sprintf('%s%s',...
                    umlStr,...
                    getPlantUmlProperties(this, ident_ + matdoc.uml.super.Base.UML_IDENT)...
                    );
            ...
            if ~this.Configuration.HideMethods
                umlStr = sprintf('%s%s',...
                    umlStr,...
                    getPlantUmlMethods(this, ident_ + matdoc.uml.super.Base.UML_IDENT)...
                    );
            ...
            if ~this.Configuration.HideEvents
                umlStr = sprintf('%s%s',...
                    umlStr,...
                    getPlantUmlEvents(this, ident_ + matdoc.uml.super.Base.UML_IDENT)...
                    );
